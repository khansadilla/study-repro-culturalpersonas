...
from prompts import cultural_norm_generation as norm_generation, scenario_generation, question_generation, answer_generation
...
def generate_norms(client, memory, retriever, country: str) -> List[Dict]:
    ...
    print("✅ Finished generating norms:", len(norms))
    return norms[:2]
    ...
    for norm in norms:
        ...
        while attempts < max_attempts:
            ...
            if len(valid_lines) == len(scenario_lines):
                ...
                break
            attempts += 1
    print("✅ Finished generating scenarios:", len(scenarios))
    return scenarios[:2]
        ...
        for trait in traits:
            ...
            while attempts < max_attempts:
                ...
                if validate(client, memory, retriever, check1) and validate(client, memory, retriever, check2):
                    ...
                    break
                attempts += 1
    print("✅ Finished generating questions:", len(questions))
    return questions[:10]
    ...
    for question in questions:
        ...
        while attempts < max_attempts:
            ...
            if validate(client, memory, retriever, check1) and validate(client, memory, retriever, check2):
                ...
                break
            attempts += 1
    print("✅ Finished generating answers:", len(answers))
    return answers[:50]
